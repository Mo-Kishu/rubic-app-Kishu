...
@Component({
  selector: 'kishuverse',
  templateUrl: './kishuverse.component.html',
  styleUrls: ['./kishuverse.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class KishuverseComponent {
  ...
  public kishuverseIcon = {
    light: 'assets/images/icons/header/kishuverse.svg',
    dark: 'assets/images/icons/header/kishuverse-light.svg'
  };
